@extends('layouts.appAdn', ['title'=>'Mon Profile'])
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span
                                        class="h2 font-weight-bold mb-0 text-white">{{ count(Auth::user()->dossiers->where('status', 0)) }}</span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span
                                        class="h2 font-weight-bold mb-0 text-white">{{ count(Auth::user()->dossiers->where('status', 3)) }}</span>
                                </div>
                                <div class="col-auto">
                                    <div class="icon icon-shape bg-white text-dark rounded-circle shadow">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('admin.profile.edit', Auth::user()->id) }}"
                                class="btn btn-sm btn-fodac-2">Modifier mon compte</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-last-name" class="form-control"
                                            placeholder="Last name" readonly value="{{ Auth::user()->last_name }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

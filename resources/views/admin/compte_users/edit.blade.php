          ...
          <form class="style-form" action="{{ route('compte.users.update', $user) }}" method="POST">
            ...
            <div class="col-md-12 input-group-lg">
              ...
              <div class="col-lg-12 mb-1">
                ...
                <div class="col-lg-6 mb-3 p-0 text-right">
                  <h4 class="mb text-uppercase title"> <a class="btn brook-btn" href=""><i class="fa fa-list"></i> Utilisateurs</a> </h4>
                </div>
              </div>
              <div class="col-lg-6 mb-3">
                <label class="title" for="last_name">Nom{!! $etoile !!}</label>
                <input type="text" name="last_name" class="form-control" value="{{old('last_name', $user->last_name)}}" readonly>
              ...
              <div class="col-lg-6 mb-3">
                ...
                <input type="text" name="first_name" class="form-control" value="{{old('first_name', $user->first_name)}}" readonly>
              ...
              <div class="col-lg-6 mb-3">
                ...
                <input type="text" name="contact" class="form-control" value="{{old('contact', $user->contact)}}" readonly>
            ...
            <div class="col-md-12 input-group-lg mt-5">
              <div class="col-lg-12 mb-3">
                  ...
                  <button type="submit" id="enregistrer" class="btn brook-btn btn-lg"><i class="fa fa-check"></i> Valider</button>
              </div>
            </div>

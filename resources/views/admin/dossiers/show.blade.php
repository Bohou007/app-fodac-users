    ...
    <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username"> <b>Nom & prénoms du demandeur</b></label> <br>
                                        {{ $dossier->user->last_name }} {{ $dossier->user->first_name }}
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email"><b>Adresse Email</b></label><br>
                                        {{ $dossier->user->email }}
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.observations.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="pl-lg-12">
                            <div class="form-group">
                                ...
                                <select required name="decision" id="" class="form-control">
                                    <option value="">--</option>
                                    <option value="2">Dossier en attente</option>
                                    <option value="3">Dossier validé</option>
                                    <option value="4">Dossier refusé</option>
                                </select>
                            </div>
                        </div>
                        <!-- Description -->
                        <div class="pl-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" required name="content" id="observation" cols="30"
                                    rows="10"></textarea>
                            </div>
                        </div>
                        <div class="pl-lg-12">

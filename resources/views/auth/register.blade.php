...
<body class="cui-config-borderless cui-menu-colorful cui-menu-left-shadow">
    ...
    <div
    class="cui-register"
    style="background-image: url({{ asset('images/bg-regisjter.jpg') }})"
  >
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="js-wizard-classic-validation block">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active">
                                    <a class="inactive" href="#validation-classic-step1" data-toggle="tab">1. Information personnelle</a>
                                </li>
                                <li>
                                    <a class="inactive" href="#validation-classic-step2" data-toggle="tab">2. Confidentialité (vos Access)</a>
                                </li>

                                <li>
                                    <a class="inactive" href="#validation-classic-step3" data-toggle="tab">3. Information supplementaire </a>
                                </li>
                            </ul>
                            <!-- END Step Tabs -->
                            ...
                            <form class="js-form1 validation form-horizontal" action="{{ route('register') }}" method="POST" enctype="application/x-www-form-urlencoded">
                                    @csrf

                                    <input type="text" name="account_type" value="{{ __('OC') }}" id="" hidden>
                                <!-- Steps Content -->
                                <div class="block-content tab-content">
                                    ...
                                    <div class="tab-pane push-30-t push-50 active" id="validation-classic-step1">
                                        <div class="form-group">
                                            <div class="col-xl-12">
                                                ...
                                                <input id="lastname" type="text" placeholder="Entrer votre nom" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" autocomplete="lastname" autofocus>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xl-12">
                                                ...
                                                <input class="form-control @error('firstname') is-invalid @enderror" type="text" id="firstname" name="firstname" placeholder="Entrer vos prenoms" value="{{ old('firstname') }}" autocomplete="firstname" autofocus>
                                                @error('firstname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xl-12 mx-auto">
                                                ...
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Entre votre adresse email" name="email" value="{{ old('email') }}" autocomplete="email">
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xl-12 mx-auto">
                                                ...
                                                <input class="form-control @error('contact') is-invalid @enderror" type="tel" id="contact"  value="{{ old('contact') }}" autocomplete="contact" name="contact" placeholder="Entrez votre numéro de téléphone">
                                    ...
                                    <div class="tab-pane push-30-t push-50" id="validation-classic-step2">
                                        <div class="form-group">
                                            <div class="col-xl-12 mx-auto">
                                                <label for="validation-classic-email">{{ __('Mot de passe') }} </label>
                                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Entrer votre mot de passe" name="password" autocomplete="new-password">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xl-12 mx-auto">
                                                <label for="validation-classic-email">{{ __('Confirmez votre mot de passe') }}</label>
                                                <input id="password-confirm" type="password" class="form-control" placeholder="Confirmez votre mot de passe" name="password_confirmation" autocomplete="new-password">
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane push-30-t push-50" id="validation-classic-step3">
                                        <div class="form-group">
                                            <div class="col-xl-12">
                                                <label for="validation-classic-skills">{{ __('Quel est votre profile') }}</label>
                                                <select class="form-control" id="profil" name="profil" size="1">
                                        ...
                                        <div id="getProfil">
                                            <div class="form-group">
                                                <hr><br>
                                                <div class="col-xl-12 bg-gray-light" style="padding:15px;">
                                                    <h4>Profile Entreprise</h4>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-xl-12 mx-auto">
                                                    <label for="namecorporate">{{ __('Nom de l\'entreprise') }}</label>
                                                    <input id="namecorporate" type="text" required placeholder="Entrer votre nom entreprise" class="form-control @error('namecorporate') is-invalid @enderror" name="namecorporate" value="{{ old('namecorporate') }}" autocomplete="name" autofocus>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xl-12 mx-auto">
                                                    <label for="emailcorporate">{{ __('Adresse email de l\'entreprise') }}</label>
                                                    <input id="emailcorporate" type="email" class="form-control @error('emailcorporate') is-invalid @enderror" placeholder="Entre l'adresse email de votre entreprise" name="emailcorporate" value="{{ old('emailcorporate') }}" autocomplete="email">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xl-12 mx-auto">
                                                    <label for="contactcorporate">{{ __('Contact Entreprise') }}</label>
                                                    <input class="form-control @error('contactcorporate') is-invalid @enderror" type="tel" id="contactcorporate"  value="{{ old('contactcorporate') }}" autocomplete="tel" name="contactcorporate" placeholder="Entrez le numéro de téléphone de votre entreprise">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xl-12 mx-auto">
                                                    <label for="registcorporate">{{ __('Numero de registre de commerce de l\'entreprise') }}</label>
                                                    <input class="form-control @error('registcorporate') is-invalid @enderror" type="text" id="registcorporate"  value="{{ old('registcorporate') }}" autocomplete="number" name="registcorporate" placeholder="Entrez le registe de commerce de votre entreprise">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xl-12 mx-auto">
                                                    <label for="addresscorporate">{{ __('Adresse de l\'entreprise') }}</label>
                                                    <input class="form-control @error('addresscorporate') is-invalid @enderror" type="text" id="addresscorporate"  value="{{ old('addresscorporate') }}" autocomplete="number" name="addresscorporate" placeholder="Entrez l'adresse de votre entreprise">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xl-12">
                                                <label class="css-input switch switch-sm switch-primary" for="validation-classic-terms">
                                                    <input type="checkbox" id="validation-classic-terms" name="terms_conditions"><span></span> Agree with the <a data-toggle="modal" data-target="#modal-terms" href="#">terms</a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="block-content block-content-mini block-content-full border-t">
                                    <div class="row col-xl-12">
                                        <div class="col-md-6 col-xl-6">
                                            <button class="wizard-prev btn btn-fodac-4 text-left" type="button"><i class="fa fa-arrow-left"></i> Previous</button>
                                        </div>
                                        <div class="col-md-6 col-xl-6 block-right text-right">
                                            <button class="wizard-next btn btn-fodac-2" type="button">Next <i class="fa fa-arrow-right"></i></button>
                                            <button class="wizard-finish btn btn-fodac-2" type="submit"><i class="fa fa-check"></i> Submit</button>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="text-center mt-4 font-weight-light">
                                            Vous avez déja un compte ? <a href="{{ route('login') }}" class="text-primary cui-utils-link-blue cui-utils-link-underlined">Connectez-vous</a>
                                        </div>
                                    </div>
                                </div>

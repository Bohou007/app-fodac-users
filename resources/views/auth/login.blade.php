...
<body class="cui-config-borderless cui-menu-colorful cui-menu-left-shadow">
 ...
 <div
    class="cui-login"
    style="background-image: url({{ asset('images/bg-rvegister.jpg') }})"
    >
    ...
    <div class="cui-login-block cui-login-block-extended">
        ...
        <div class="col-xl-12">
            ...
            <div class="cui-login-block-form">
                ...
                <br />
                <form  class="js-form1 validation" action="{{ route('login') }}" id="form-validations" name="form-validations" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                    <label class="form-label">Addresse E-mail</label>
                    <input id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus
                ...
                <div class="form-group">
                    ...
                    <input id="validation-password" class="form-control password @error('password') is-invalid @enderror" name="password"
                ...
                <div class="form-group">
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="pull-right cui-utils-link-blue cui-utils-link-underlined">
                ...
                <div class="form-actions">
                    <div class="text-center font-weight-light">
                        <button type="submit" class="btn btn-block btn-fodac-2 mr-3">{{ __('Se Connecter') }}</button>
                    </div>
                    <div class="text-center mt-4 font-weight-light">
                        Vous n'avez pas de compte ? <a href="{{ route('register') }}" class="text-primary cui-utils-link-blue cui-utils-link-underlined">Créer un compte</a>
                    </div>
                </div>
                </form>
            </div>

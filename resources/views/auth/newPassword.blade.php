                    ...
                    <div class="cui-login-block-inner">
                        <div class="cui-login-block-form">
                            <h4 class="text-uppercase">
                                <strong>Activation de compte</strong>
                            </h4>
                            <br />
                            <form class="js-form1 validation" action="{{ route('admin.activate.passwordUpdate', $token) }}" id="form-validations"
                                name="form-validations" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="form-label">Nouveau mot de passe</label>
                                    <input id="validation-password" class="form-control password" name="password" type="password" required autocomplete="current-password" placeholder="Mot de passe" />
                                    @error('password')
                                ...
                                <div class="form-group">
                                    <label class="form-label confirmation_password">Confirmer votre mot de passe</label>
                                    <input id="validation-confirmation-password" class="form-control confirmation_password @error('confirmation_password') is-invalid @enderror" name="confirmation_password" type="password" required placeholder="Confirmez votre mot de passe" />
                                </div>
                                <div class="form-actions">
                                    <div class="text-center font-weight-light">
                                        <button type="submit"
                                            class="btn btn-block btn-fodac-2 mr-3">{{ __('Enregistrer') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>

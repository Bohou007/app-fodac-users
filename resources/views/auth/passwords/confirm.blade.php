...
<head>
    ...
    <title>
        Confirmez votre mot de passe - Fodac
    </title>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="cui-login-block-inner">
                        <div class="cui-login-block-form">
                            ...
                            <br />
                            <form class="js-form1 validation" action="{{ route('password.confirm') }}" id="form-validations"
                                ...
                                <div class="form-actions">
                                    <div class="text-center font-weight-light">
                                        <button type="submit"
                                            class="btn btn-block btn-fodac-2 mr-3">{{ __('Se Connecter') }}</button>
                                    </div>

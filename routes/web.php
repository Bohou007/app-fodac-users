...
function () {
    ...
    Route::group(['middleware' => ['permission:fodac_agent']], function () {
        // UTILISATEURS
        Route::group(['prefix' => 'admin/dashboard'], function () {
            ...
            Route::group(['prefix' => 'dossiers'], function() {
                /* Comptes Admin */
                    Route::get('/', 'DossiersController@index')->name('admin.allDossiers')->middleware(['permission:voir_dossiers']);
                    Route::get('/traite-dossier/{id}', 'DossiersController@traiteDossierUpdate')->name('admin.traiteDossieerUpdate')->middleware(['permission:traiter_dossiers']);
                    Route::get('/show-dossier/{dossier_id}', 'DossiersController@dossierShow')->name('admin.DossierShow')->middleware(['permission:voir_dossiers']);
                    ...
                    Route::get('/assigned-fond', 'FondDossierController@index')->name('assigned-fond.index')->middleware(['permission:approuver_dossiers']);
                    Route::get('/assigned-fond/approve/{id}', 'FondDossierController@show')->name('assigned-fond.show')->middleware(['permission:ajouter_fonds_dossiers']);
                    Route::post('/assigned-fond/approve/post', 'FondDossierController@store')->name('assigned-fond.store')->middleware(['permission:ajouter_fonds_dossiers']);
